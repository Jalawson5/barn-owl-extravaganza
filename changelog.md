...
* The name saved in the character creator window is now copied to the name input window.
...
* Updated the Character Creation menu to be able to open the naming window. The Character Creation menu now properly ignores input while the naming window is open.
